...
?>
    ...
    <a class="sociaux" href="https://tiktok.com">
        <img src="https://s2.svgbox.net/social.svg?ic=tiktok&color=<?= $couleur ?>" width="32" height="32">
    </a>
    <a class="sociaux" href="https://github.com/ChantalP-7/33w">
